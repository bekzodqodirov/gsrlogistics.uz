...
const uz: FaqStrings = {
  ...
  intro: 'Bu sahifada Xitoydan Oʻzbekistonga yuk tashish boʻyicha {count} ta savolga qisqa javob bor: yigʻma yuk taxminan {truckDays} kun, avia {airDays} kun, narx {truckFrom}/kg dan, bojxona — rasmiy, GTD bilan. Savolingiz topilmasa, Telegramda yozing — menejer yukingiz boʻyicha aniq raqam bilan javob beradi.',
...
const ru: FaqStrings = {
  ...
  intro: 'На этой странице — короткие ответы на {count} вопроса о доставке грузов из Китая в Узбекистан: сборный груз ориентировочно {truckDays} дней, авиа {airDays} дней, цена от {truckFrom}/кг, таможенное оформление официальное, с ГТД. Не нашли ответ — напишите в Telegram, менеджер посчитает именно ваш груз.',
