...
const uz: TrackingStrings = {
  ...
  intro: 'Yuk kodini kiriting — yukingizning oltita bosqichdan qaysi birida ekanini koʻrasiz: Ivu omborida qabul, konsolidatsiya, yoʻlda, Xorgos chegarasi va bojxona, Toshkent ombori, topshirildi. Kod Ivu omborida qabul qilinganda menejer yuborgan foto-hisobotda boʻladi. Savol boʻlsa, menejer Telegramda holat va foto bilan javob beradi.',
  form: {
  ...
  stages: {
    ...
    delivered: { name: 'Topshirildi', short: 'Topshirildi', text: 'Yuk sizga yoki vakilingizga topshirildi. Buyurtma yopildi.' },
  },
  sampleTag: 'Namuna',
...
const ru: TrackingStrings = {
  ...
  intro: 'Введите код груза — и увидите, на каком из шести этапов он находится: приёмка на складе в Иу, консолидация, в пути, граница Хоргос и таможня, склад в Ташкенте, выдан. Код указан в фотоотчёте, который менеджер присылает при приёмке в Иу. Если есть вопрос, менеджер ответит в Telegram со статусом и фото.',
  form: {
  ...
  stages: {
    ...
    delivered: { name: 'Выдан', short: 'Выдан', text: 'Груз передан вам или вашему представителю. Заказ закрыт.' },
  },
  sampleTag: 'Пример',
...
const en: TrackingStrings = {
  ...
  intro: 'Enter your cargo code to see which of six stages your shipment is at: received at the Yiwu warehouse, consolidation, in transit, Khorgos border and customs, Tashkent warehouse, delivered. The code is in the photo report your manager sends when the cargo is received in Yiwu. For anything else, your manager replies on Telegram with the status and a photo.',
  form: {
