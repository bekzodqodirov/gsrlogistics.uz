...
const uz: PricingStrings = {
  ...
  page: {
    ...
    rail: {
      ...
      c20: '20 futlik konteyner (≈ 28 m³, 20 t gacha)',
      c40: '40 futlik konteyner (≈ 58 m³, 26 t gacha)',
...
const ru: PricingStrings = {
  ...
  page: {
    ...
    tiles: { truck: 'Авто карго (сборный груз)', air: 'Авиа карго', lcl: 'Объёмный груз (LCL)', rail: 'Контейнер 20 футов', fromKg: '$/кг от', fromM3: '$/м³ от', fromContainer: '$ от' },
    truck: {
    ...
    rail: {
      ...
      c20: '20-футовый контейнер (≈ 28 м³, до 20 т)',
      c40: '40-футовый контейнер (≈ 58 м³, до 26 т)',
...
const en: PricingStrings = {
  ...
  page: {
    ...
    tiles: { truck: 'Truck cargo (consolidated)', air: 'Air cargo', lcl: 'Bulky cargo (LCL)', rail: '20 ft container', fromKg: '$/kg from', fromM3: '$/m³ from', fromContainer: '$ from' },
    truck: {
      title: 'Truck cargo (consolidated) — how much per kg?',
      intro: 'Truck cargo is consolidated at the China warehouse and travels by lorry through Khorgos to Tashkent. The rate steps down with chargeable weight: the heavier the lot, the cheaper each kilogram.',
    ...
    rail: {
      ...
      c20: '20 ft container (≈ 28 m³, up to 20 t)',
      c40: '40 ft container (≈ 58 m³, up to 26 t)',
    ...
    payment: {
      title: 'How do I pay?',
      paragraphs: [
        'Prices are calculated in US dollars and paid in soʻm at the settlement rate (currently $1 = {rate} UZS, indicative). The rate is announced for each batch.',
    ...
    how: {
      ...
      paragraphs: [
        'A cargo rate has three parts: collection and receiving at the China warehouse, transport along the China — Khorgos — Tashkent route, and clearance in Tashkent. With consolidated cargo you pay for your space only, not the whole lorry — which is why the per-kilogram price sits well below container hire.',
        'Space in a lorry is limited, so light, bulky cargo is billed by the cubic metre rather than the kilogram. The line is {threshold} kg/m³: denser cargo goes at the per-kg rate, lighter cargo at the per-m³ rate. This is the market’s common rule, and ours is written openly in the table.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'When and how do I pay?', a: 'When the cargo reaches the Tashkent warehouse, before release — in soʻm at the settlement rate. Cash, card, Click/Payme; invoice for legal entities. No prepayment required.' },
  ...
  calcPage: {
    ...
    intro: 'Enter weight, dimensions and goods category — the calculator estimates the price by truck, air or rail on the {date} rates: the rule applied, the rate, the total in dollars and soʻm, and the transit time. Truck from {truck}/kg, air from {air}/kg. The exact price is confirmed after weighing at the Yiwu warehouse.',
    ...
    steps: [
      ...
      { title: 'Works out the total', text: 'Rate × chargeable weight or volume. In dollars and soʻm, with a {days}-day transit and a ready Telegram message.' },
    ],
