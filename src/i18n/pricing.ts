...
const uz: PricingStrings = {
  ...
  page: {
    ...
    intro: 'Xitoydan Toshkentga kargo 1 kg — avto (yigʻma yuk) {truck} dan, avia — {air} dan ({month}). Yengil, hajmli yuk m³ boʻyicha {lcl} dan: zichlik {threshold} kg/m³ dan past boʻlsa — m³, yuqori boʻlsa — kg hisobida. Narxga Xitoy omborida qabul, oʻlchash, konsolidatsiya va Toshkent omborigacha yetkazish kiradi; boj, QQS va sugʻurta — alohida.',
  ...
  calcPage: {
    ...
    intro: 'Vazn, oʻlcham va tovar toifasini kiriting — kalkulyator avto, avia yoki temir yoʻl uchun taxminiy narxni {date} tariflari boʻyicha hisoblaydi: qoʻllangan qoida, tarif, dollar va soʻmdagi summa, muddat. Avto — {truck}/kg dan, avia — {air}/kg dan. Aniq narx Xitoy omborida tortilgandan keyin tasdiqlanadi.',
...
const ru: PricingStrings = {
  ...
  page: {
    ...
    intro: 'Карго из Китая в Ташкент за 1 кг — авто (сборный груз) от {truck}, авиа — от {air} ({month}). Лёгкий объёмный груз считаем по м³ от {lcl}: при плотности ниже {threshold} кг/м³ — по м³, выше — по кг. В цену входят приёмка на складе в Китае, обмер, консолидация и доставка до склада в Ташкенте; пошлина, НДС и страховка — отдельно.',
  ...
  calcPage: {
    ...
    intro: 'Введите вес, размеры и категорию товара — калькулятор считает ориентировочную цену для авто, авиа или ж/д по тарифам на {date}: применённое правило, тариф, сумму в долларах и сумах, срок. Авто — от {truck}/кг, авиа — от {air}/кг. Точная цена подтверждается после взвешивания на складе в Китае.',
...
const en: PricingStrings = {
  ...
  calcPage: {
    ...
    intro: 'Enter weight, dimensions and goods category — the calculator estimates the price by truck, air or rail on the {date} rates: the rule applied, the rate, the total in USD and UZS, and the transit time. Truck from {truck}/kg, air from {air}/kg. The exact price is confirmed after weighing at the China warehouse.',
