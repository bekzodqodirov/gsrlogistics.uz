...
const uz: PrivacyStrings = {
  ...
  sections: [
    ...
    { heading: 'Kimga uzatiladi?', bullets: ['Telegram (Telegram FZ-LLC, serverlari Oʻzbekistondan tashqarida) — siz Telegram orqali yozganingizda yoki forma xabari Telegramga uzatilganda.', 'Cloudflare (AQSH) — sayt hostingi va forma soʻrovlarini uzatish; Cloudflare maʼlumotlarni saqlamaydi.', 'Google Sheets (AQSH) — faqat yuk kuzatuvi uchun shaxsga tegishli boʻlmagan maʼlumotlar (kod, bosqich, sana), agar bu funksiya yoqilgan boʻlsa.', 'Yandex Metrika (Rossiya) — faqat yoqilgan boʻlsa; anonimlashtirilgan tashrif statistikasi.', 'Davlat organlari — faqat qonun talab qilgan hollarda.'] },
