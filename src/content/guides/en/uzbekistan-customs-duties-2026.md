---
title: "Uzbekistan customs duties on goods from China in 2026: what do individuals and companies pay?"
description: "In 2026 customs charges on cargo from China follow two paths: an individual pays nothing on courier parcels up to $200 a month and 30% (min $3/kg) on the excess; a company or sole trader pays duty by HS code + 12% VAT + a clearance fee in BRV. Duty table, two worked examples, document checklist and lex.uz references."
lang: en
translationKey: customs-2026
slug: uzbekistan-customs-duties-2026
...
sources:
  ...
  - title: "Presidential Resolution PP-3818, Annex 1 — import duty schedule (as amended by PP-58 of February 11, 2026)"
    ...
    date: "2026-02-11"
  - title: "Gazeta.uz — PKM-55: customs clearance fee in BRV and 2% of BRV per kg of courier parcels"
    url: "https://www.gazeta.uz/ru/2025/02/03/customs-duties/"
    date: "2025-02-03"
  - title: "Gazeta.uz — Customs Committee: the 30% payment applies only to the amount above the allowance"
    url: "https://www.gazeta.uz/uz/2025/07/29/kuryerlik/"
    date: "2025-07-29"
  - title: "Gazeta.uz — checking courier shipments and the remaining allowance on my.gov.uz"
    url: "https://www.gazeta.uz/uz/2025/12/30/courier-shipments/"
    date: "2025-12-30"
  - title: "Presidential Decree UP-250 — 20% lower fee for preliminary declaration, deferral up to 120 days"
    url: "https://lex.uz/ru/docs/7934918"
    date: "2025-12-17"
  - title: "Buxgalter.uz — PKM-554: the mandatory certification list has been cut"
    url: "https://buxgalter.uz/publish/doc/text210396_po_kakoy_produkcii_ne_nujna_obyazatelnaya_sertifikaciya_v_uzbekistane"
    date: "2025-09-10"
  - title: "Norma.uz — UP-140: no SES conclusion without labelling in the state language"
    ...
    date: "2023-08-16"
  - title: "my.gov.uz — registering a foreign-trade contract in EEISVO (E-Contract)"
    url: "https://my.gov.uz/ru/service/96"
    date: "2026-09-08"
  - title: "Gratanet — PKM-283: prepaid goods must arrive within 180 days"
    url: "https://gratanet.com/ru/news/foreign-trade-operations-is-approved-in-uzbekistan"
    date: "2020-05-20"
  - title: "PwC Tax Summaries — import VAT in Uzbekistan is 12%"
...
1. **Customs value** = the invoice price of the goods + transport and insurance from China to the Uzbek border.
2. **Duty** = customs value × the rate for the HS code (PP-3818, Annex 1, as amended by PP-58 of February 11, 2026). Many lines read "percentage, but no less than … $ per piece (kg, pair)" — the higher amount applies. China has no free-trade agreement with Uzbekistan, so MFN rates apply; without a certificate of origin the rate doubles.
3. **VAT 12%** = (customs value + duty + excise) × 12%. Excise applies only to alcohol, tobacco, fuel, cars and, from April 1, 2026, sugary and energy drinks and chips — ordinary consumer goods carry none. Import VAT is deductible for VAT payers.
4. **Customs clearance fee** — in BRV, by consignment value (PKM-55 of January 31, 2025):
...
1. **Foreign-trade contract** registered in EEISVO (E-Contract, service 96 on my.gov.uz) — since May 19, 2025 all foreign-trade paperwork runs through this system; banks refuse payments on an unregistered contract.
2. **Invoice** — product names, quantity, price, currency, delivery term (EXW, FOB).
3. **Packing list** — number of packages, gross and net weight, volume.
4. **Transport document** — CMR (road), SMGS (rail) or AWB (air).
5. **Certificate of origin** — to keep the MFN rate; without it the duty doubles.
6. **HS code** — the 10-digit classification for every product line.
7. **Certificate or declaration of conformity, SES conclusion** — where the HS code requires them, before the declaration is filed.
8. **Electronic customs declaration (GTD)** — filed by a customs broker or by you; under the Customs Code release takes 1 working day, excluding approvals by other agencies.
