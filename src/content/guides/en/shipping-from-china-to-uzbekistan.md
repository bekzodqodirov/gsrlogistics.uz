---
title: "How do you ship cargo from China to Uzbekistan? The complete 2026 guide"
description: "Three ways to ship from China to Uzbekistan (truck 15–25 days, air 5–10, rail 20–35), the Yiwu → Khorgos → Tashkent route, 7 steps from request to pickup, documents, customs limits and estimated prices as of September 2026."
lang: en
...
sources:
  - title: "Cabinet of Ministers Resolution No. 244 — duty-free import norms for individuals (lex.uz)"
    ...
    date: "2025-04-19"
  - title: "Presidential Decree PF-174 'New Customs 2030': single customs payment 20% from January 1, 2027 (lex.uz)"
    url: "https://lex.uz/docs/8444993"
    date: "2026-08-27"
  - title: "Buxgalter.uz — new customs fee rates approved (Cabinet Resolution No. 55)"
    url: "https://buxgalter.uz/publish/doc/text205996_utverjdeny_novye_stavki_tamojennyh_sborov"
    date: "2025-01-31"
  - title: "Gazeta.uz — Tashkent–Andijan–Osh–Irkeshtam–Kashgar road corridor opened"
    url: "https://www.gazeta.uz/ru/2018/02/19/road/"
    date: "2018-02-19"
  - title: "Ritm Eurasia — Altynkol–Khorgos rail junction upgrade to finish in 2026"
    ...
    date: "2026-02-24"
  - title: "Transasia — how much shipping from China to Uzbekistan costs (market price review)"
...
Transit times count from departure from the China warehouse. Full tariffs and rules are on the [Pricing](/en/pricing/) page; the mode comparison is on the [Truck cargo](/en/services/truck-cargo/) service page.
...
The main corridor for truck and rail runs through Kazakhstan:

1. **Yiwu → Xi'an → Lanzhou → Urumqi** — about 4,000 km inside China, 4–6 days.
2. **Urumqi → Khorgos** — the China–Kazakhstan border. Export formalities and queues happen here: usually 1–3 days, 5–7 days before holidays.
3. **Khorgos → Almaty → Shymkent → Tashkent** — 1,100 km across Kazakhstan, entering Uzbekistan at the Yallama (Gishtkuprik) post. An electronic queue has operated at Yallama since June 2025.

The alternative is **Kashgar → Irkeshtam → Osh → Andijan**, shorter for the Fergana Valley. The Tashkent–Andijan–Osh–Irkeshtam–Kashgar corridor opened on February 25, 2018 (Gazeta.uz, February 19, 2018). Mountain passes make it unreliable in winter.

Rail containers cross at the **Dostyk or Altynkol** border stations, reach Saryagash and continue to Tashkent. The Altynkol–Khorgos junction upgrade finishes in 2026 and raises capacity from 18 to 33 train pairs a day (Ritm Eurasia, February 24, 2026). The China–Kyrgyzstan–Uzbekistan railway is still under construction — it is not operating in 2026, so do not plan around it.

Air cargo flies from Guangzhou or Urumqi to Tashkent airport and is cleared at the bonded warehouse.
...
7. **You receive the cargo.** At the Tashkent warehouse you settle the invoice in soums and collect the goods, or we forward them to your region: free to a branch, UZS 20,000–30,000 to the door; in Tashkent door delivery is free from 5 kg. Storage in Tashkent is free for 3 days.

## Which documents are needed and what happens at customs?

Customs distinguishes two regimes, and they must not be mixed.

**Individuals, personal use.** Under Cabinet of Ministers Resolution No. 244 of April 19, 2025, from May 1, 2025 the limit for international courier shipments is $200 per calendar month, cumulative across all orders and tracked by personal ID (PINFL). The excess is subject to the single customs payment of 30%, minimum $3/kg. Decree PF-174 of August 27, 2026 lowers this to 20% and $2/kg from January 1, 2027 — a planned change, not yet in force. Large quantities of identical goods or repeated orders may be classed by customs as a commercial shipment.

**Legal entities and sole traders, commercial goods.** The set: a contract registered in E-Contract (mandatory since May 19, 2025), invoice, packing list, CMR (road) or SMGS (rail) waybill, certificate of origin, a 10-digit HS (TN VED) code and, where required, a conformity certificate and a sanitary (SES) conclusion. Payments: duty by HS code at 0–30% (clothing 20%, phones 5%, computers 0%, furniture 15%), VAT 12%, and the customs fee of 1 BRV for values up to $10,000 (Cabinet Resolution No. 55 of January 31, 2025). The GTD is what allows the goods to be sold legally in a shop or on a marketplace.

We prepare the documents, classify the goods and calculate the payments in advance; see the [Customs clearance](/en/services/customs/) page and the [Uzbekistan customs duties 2026](/en/guides/uzbekistan-customs-duties-2026/) guide.
...
Not accepted at all: explosives and flammables; plants, animals and perishables; cash, precious metals and stones, jewellery, antiques; payment instruments, securities, documents; drones (banned for individuals); anything prohibited by law.

Truck only: lithium batteries and power banks, liquids, cosmetics and perfume, magnetic items — airlines refuse them. Medicines, walkie-talkies and radio equipment require permits. The full list is in the [Prohibited goods](/en/guides/prohibited-goods/) guide.

## How long does it take and what causes delays?

In normal conditions a truck arrives in 15–25 days; the fastest deliveries in GSR's experience took 12–13 days, but that is not the standard. What stretches the timeline:

- **Chinese New Year** (late January – February): warehouses stop shipping a week before the holiday and the first truck leaves 2–3 weeks later. Order February stock in December.
- **October 1–7** (Golden Week) and the **November 11** sales — factories and warehouses are overloaded, and queues form at the border.
- **Queues at Khorgos and Yallama** — 3–7 days before holidays and at year end.
- **Document errors** — if the invoice description does not match the HS code, the cargo waits at customs. That is why we check the documents before departure.
...
Whether your goods are already in China or still to be found, tell us the cargo, the city and the deadline, and we will propose a price and a route: [Truck cargo](/en/services/truck-cargo/), [Pricing](/en/pricing/), [Calculator](/en/calculator/).
