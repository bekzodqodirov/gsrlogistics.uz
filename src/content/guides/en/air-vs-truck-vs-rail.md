...
faq:
  ...
  - q: "Can I ship a product with a lithium battery by air?"
    a: "No. Lithium batteries, power banks, liquids, perfume, magnets and medicines are not accepted by air — that is an airline safety requirement. Such goods travel by truck (consolidated freight) or by rail."
  - q: "Why is rail slower than truck?"
    a: "At the Dostyk or Altynkol border the container waits for a gauge change (Chinese and CIS railways use different track widths) and for a terminal slot. That is why rail takes roughly 20–35 days; in return the price is fixed per container and works out lower for large lots."
sources:
  - title: "AGL — Shipping from China to Uzbekistan in 2026: costs and transit times"
    ...
    date: "2026-06-18"
  - title: "Transasia — How much shipping from China to Uzbekistan costs (air, truck, rail)"
  ...
  - title: "Ritm Eurasia — Altynkol–Khorgos rail hub modernisation to finish in 2026"
    ...
    date: "2026-02-24"
  - title: "IATA — Lithium Batteries: rules for carriage by air"
...
## When is truck cargo the right choice?

Truck cargo means carrying your goods by lorry from China through Kazakhstan to Tashkent. GSR Logistics receives the cargo at the Yiwu (义乌) warehouse, loads it into one truck together with other clients' goods — hence "consolidated" — and delivers it via Urumqi, Khorgos, Almaty and Shymkent to Tashkent. You pay for your space only, not for the whole truck.
...
## Who needs rail and containers?

Rail means moving a whole container (FCL) or part of one (LCL) by train. The container travels on the Chinese railway to the Dostyk or Altynkol border, is transferred to the wider CIS gauge, then continues through Kazakhstan and Saryagash to Tashkent. Transit is roughly 20–35 days; the price is per container: 20 ft $2,800–5,500, 40 ft $5,200–6,800.

Rail suits you if:

- the lot is above 25 m³ and belongs to one client — the container is sealed and not opened en route;
- the cargo is heavy: machinery, raw materials, furniture, building materials — the cost per cubic metre drops to $100–200;
- a lead time of about a month is acceptable.

Note: the China–Kyrgyzstan–Uzbekistan railway is still under construction; today all rail cargo comes through Kazakhstan. Details on the [Rail and container shipping](/en/services/rail-container/) page.

## Price comparison: four worked examples
...
All figures come from the rate table and are estimates; insurance (1% of declared value), customs payments and regional delivery are charged separately. How volumetric weight and density are calculated is explained in the guide [How cargo prices are calculated](/en/guides/how-cargo-prices-are-calculated/).

## What makes up the transit time?

"15–25 days" is the time from departure from the Yiwu warehouse to arrival at the Tashkent warehouse. The full chain looks like this:

| Stage | Air | Truck | Rail |
|---|---|---|---|
| Supplier to the Yiwu warehouse (inside China) | 2–5 days | 2–5 days | 2–7 days |
| Receiving, inspection, photo report, consolidation | 1–3 days | 1–3 days | 2–5 days |
| Road and border | 5–10 days | 15–25 days | 20–35 days |
| Customs clearance in Tashkent | 1–2 working days | 1–2 working days | 1–3 working days |
| Total (roughly) | 9–20 days | 19–35 days | 25–50 days |

By truck, most of the waiting happens at the Khorgos border: a 1–3-day queue, up to 5 days before holidays. By rail it is the gauge transfer at the Dostyk/Altynkol terminal; the Altynkol–Khorgos hub is being modernised in 2026 and capacity will rise. By air, the time mostly depends on the schedule: lots fly 1–2 times a week.

## Which goods cannot travel by which mode?

**By no mode:** explosives and flammables; plants, animals and perishables; cash, precious metals and stones, jewellery, antiques; means of payment, securities, documents; anything prohibited by law; brand copies (counterfeits).

**Not by air:** lithium batteries and accumulators (power banks, e-scooters, wireless earbuds), liquids and cosmetics, perfume, magnets and magnetic toys, medicines and medical devices, drones and GPS trackers, SIM smartwatches, aerosols.

**With a permit:** radio and Wi-Fi devices (certificate), food and tableware (sanitary conclusion), medicines (Ministry of Health permit). The full list is in the guide [Prohibited goods](/en/guides/prohibited-goods/).
...
- **Chinese New Year (late January — February).** Factories stop for 2–3 weeks. Warehouses usually ship the last truck lot around January 23 and the last air lot around January 31; the first departure comes after mid-February. Uzum and Instagram sellers are advised to hold a two-month stock.
- **Golden Week (October 1–7).** Factories and logistics pause for a week, then queues stretch by 1–2 weeks.
