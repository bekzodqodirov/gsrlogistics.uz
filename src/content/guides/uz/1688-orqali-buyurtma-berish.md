---
title: "1688 orqali buyurtma berish: Oʻzbekistondan qanday sotib olinadi va yuk Toshkentga qanday keladi?"
description: "1688 — Alibaba guruhining Xitoy ichki ulgurji bozori: zavod narxi, minimal partiya (MOQ), faqat xitoy tili va Xitoy toʻlov tizimlari. Oʻzbekistondan toʻgʻridan-toʻgʻri toʻlab boʻlmaydi — GSR Logistics siz uchun sotib oladi: yuan MB kursi + 3% komissiya, Ivu ombori, avto 15–25 kun. Qadamlar, xatolar, hisoblangan misol."
lang: uz
translationKey: order-from-1688
slug: 1688-orqali-buyurtma-berish
...
faq:
  ...
  - q: "1688 va Taobao qaysi biri arzon?"
    a: "1688 arzon — bu ulgurji bozor, narx 10–50 donadan boshlanadigan minimal partiya uchun. Taobao — chakana, narx 20–40% yuqori, lekin 1 dona ham olish mumkin. Pinduoduo eng arzon chakana narxlarni beradi, lekin sifat va sotuvchi tekshiruvi zaif."
sources:
  - title: "1688.com — Alibaba guruhining Xitoy ichki ulgurji savdo maydonchasi"
    url: "https://www.1688.com/"
    date: "2026-09-08"
  - title: "Oʻzbekiston Markaziy banki — CNY rasmiy kursi arxivi (1 756,72 soʻm)"
    url: "https://cbu.uz/uz/arkhiv-kursov-valyut/json/CNY/"
    date: "2026-09-08"
  - title: "Vazirlar Mahkamasining 244-son qarori — jismoniy shaxslar uchun boj toʻlanmaydigan olib kirish normalari (kuryer joʻnatmalari 200 $/oy)"
    url: "https://lex.uz/docs/7484114"
    date: "2025-04-19"
  - title: "Spot.uz — 1-maydan kuchga kirgan bojxona qoidalari: limitlar va 30% toʻlov"
    url: "https://www.spot.uz/ru/2025/04/23/customs-rules/"
    date: "2025-04-23"
  - title: "Gazeta.uz — 2027-yil 1-yanvardan yagona bojxona toʻlovi 20% (kamida 2 $/kg)"
    url: "https://www.gazeta.uz/oz/2026/09/02/customs-payment/"
    date: "2026-09-02"
  - title: "Spot.uz — Xitoydan yetkazib berish xizmatlari: komissiya va tariflar sharhi"
...
| Toʻlov | Alipay, xitoy karta, korporativ hisob | Alipay, baʼzan xorijiy Visa | Faqat xitoy tizimlari |
...
Tovarni koʻrish uchun akkaunt shart emas — 1688.com saytini brauzerda ochib, qidirish mumkin. Buyurtma berish uchun esa xitoy telefon raqamiga bogʻlangan akkaunt, Alipay va koʻpincha xitoy shaxsiy identifikatsiyasi kerak — shuning uchun Oʻzbekistondagi xaridor odatda vositachining akkauntidan foydalanadi.

Amaliy tavsiya:

- **Ilova.** Android/iOS uchun «1688» (阿里巴巴) ilovasini oʻrnating; ilovada rasm boʻyicha qidiruv va tarjima qulayroq.
- **Tarjima.** Chrome-da sahifani avtomatik tarjima qiling; Yandex yoki Google Translate kamera rejimi ilovadagi matnni oʻqiydi. 2025-yildan 1688 ilovasining oʻzida ham inglizcha interfeys bor, lekin tovar tavsifi baribir xitoycha.
- **Kuzatish.** Havolalarni «Sevimlilar»ga emas, oʻzingizga Telegramda saqlang — vositachi bilan almashish oson boʻladi.
...
6. **Oʻlcham va rangni yozib oling.** Tovar kartasidagi 规格 (spetsifikatsiya) va 颜色 (rang) — buyurtmada shu soʻzlar bilan koʻrsatiladi.

## GSR Logistics siz uchun qanday sotib oladi?

1. **Havolalarni yuborasiz.** Telegramda tovar havolasi, kerakli rang/oʻlcham, soni. Tovar topilmagan boʻlsa — [Tovar topish](/xizmatlar/tovar-topish/) xizmati orqali biz qidiramiz.
...
Buyurtma: 300 dona telefon gʻilofi, 1688-da 100+ dona uchun narx 10 yuan.

| Modda | Hisob | Summa |
|---|---|---|
| Tovar | 300 × 10 yuan | 3 000 yuan |
| Xitoy ichida yetkazish (sotuvchi → Ivu) | sotuvchi narxi | 60 yuan |
...
**Avto kargo hajm boʻyicha hisoblanadi.** Tarifni yukning zichligi tanlaydi: zichlik = vazn (kg) ÷ hajm (m³). Yengil yuk uchun narx 110 $/m³ dan boshlanadi (100 kg/m³ gacha) va zichlashgani sari koʻtariladi — eng yuqori hajm pogʻonasi 701 kg/m³ dan boshlanadi va 320 $/m³ turadi; 1 000 kg/m³ va undan zich yuk esa 0,55 $/kg boʻyicha hisoblanadi. Hisobga olinadigan eng kichik hajm — 0,1 m³. Shuning uchun oʻsha 40 kg quti 0,2 m³ da 32 $, lekin havo bilan toʻlgan 0,5 m³ qutida (zichlik 80 kg/m³) 0,5 × 110 = 55 $ turadi — qadoqni zich qilish toʻgʻridan-toʻgʻri pulni tejaydi.
...
Uchala platformada ham GSR Logistics bir xil sxemada ishlaydi: havola → hisob → soʻmda toʻlov → yuanda xarid → Ivu ombori → Toshkent.
...
8. **Platformadan tashqari toʻlov.** Sotuvchi «WeChat orqali arzonroq» desa — rad eting: platforma himoyasi yoʻqoladi.
9. **Yuan kursini hisobga olmaslik.** Vositachining «foizsiz» taklifi koʻpincha kursdagi 5–8% ustamani yashiradi. Hisobda kurs va sanani soʻrang.

## Muddat: buyurtmadan Toshkentgacha

| Bosqich | Muddat |
|---|---|
| Havola → hisob-kitob va tasdiq | 1 ish kuni |
| Toʻlov va buyurtma berish | 1 kun |
| Sotuvchi joʻnatadi (ombordagi tovar) | 1–3 kun · buyurtmaga ishlab chiqarish: 7–15 kun |
| Xitoy ichida Ivu omboriga | 2–5 kun |
| Qabul, tekshiruv, foto-hisobot, konsolidatsiya | 1–3 kun |
| Ivu → Toshkent: avto | 15–25 kun |
| Ivu → Toshkent: avia | 5–10 kun |
| Bojxona va omborda berish | 1–2 ish kuni |
| **Jami, avto** | **≈ 25–40 kun** |
| **Jami, avia** | **≈ 12–20 kun** |

Xitoy Yangi yili (yanvar oxiri — fevral oʻrtasi) va Oltin hafta (1–7-oktabr) davrida sotuvchilar joʻnatmaydi — buyurtmani 3–4 hafta oldin bering.

> **Menejer maslahati.** Havolani yuborishdan oldin sotuvchi sahifasida 起批量 (minimal partiya) va 发货地 (joʻnatish shahri) ni qarang. Ivu yoki Guanchjou atrofidagi sotuvchidan tovar omborga 1–2 kunda keladi, shimoliy provinsiyalardan — 5–7 kunda. Bu bitta reysga ulgurish yoki keyingisini kutish degani.

Sotib olmoqchi boʻlgan tovarning havolasini yuboring — menejer bir ish kuni ichida narx, MOQ va Toshkentgacha jami summani hisoblab beradi.
