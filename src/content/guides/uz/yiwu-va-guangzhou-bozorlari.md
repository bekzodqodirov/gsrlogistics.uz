...
sources:
  - title: "Yiwugo — Ivu Xalqaro savdo shahrining rasmiy onlayn platformasi (korpuslar, doʻkon raqamlari)"
    url: "https://www.yiwugo.com/"
    date: "2026-09-08"
  - title: "Canton Fair — 140-yarmarka jadvali: 2026-yil 15-oktabr – 4-noyabr, uch bosqich"
    url: "https://www.cantonfair.org.cn/"
    date: "2026-09-08"
  - title: "XXR Davlat kengashi — 2026-yil rasmiy dam olish kunlari (Oltin hafta 1–7 oktabr, Bahor bayrami)"
    url: "https://english.www.gov.cn/"
    date: "2025-11"
  - title: "IATA — Lithium Batteries: havo yuklarida litiy batareyalarga cheklovlar (DGR 2026)"
...
Ivu Xalqaro savdo shahri (义乌国际商贸城, mahalliy nomi — Futian bozori) — bu Chjetszyan provinsiyasidagi Ivu shahrida 2002–2011-yillarda bosqichma-bosqich ochilgan 5 ta korpusdan iborat ulgurji majmua. Har bir korpus 3–5 qavat, har qavat tovar guruhiga boʻlingan, doʻkon raqami korpus va qavatni bildiradi. Bozor haftaning yetti kuni taxminan 9:00–17:00 ishlaydi va faqat Xitoy Yangi yilida uzoq yopiladi. Rasmiy onlayn platformasi — Yiwugo: doʻkon raqami boʻyicha sotuvchini topish va safardan keyin takroriy buyurtma berish uchun qulay.

| Korpus | Asosiy tovarlar | Kimga mos |
|---|---|---|
| 1-korpus | Oʻyinchoq, sunʼiy gul, taqinchoq va bijuteriya, soch aksessuarlari, suvenirlar | Oʻyinchoq doʻkonlari, Uzum va Instagram sotuvchilari |
| 2-korpus | Asbob-uskuna, elektr tovarlar, soyabon, sumka va chamadon, soat, qulf, oshxona anjomlari | Xoʻjalik mollari, qurilish doʻkonlari |
| 3-korpus | Kanselyariya, sport tovarlari, koʻzoynak, kosmetika, tugma va zamok, qogʻoz mahsulotlari | Maktab bozori, sport va goʻzallik doʻkonlari |
| 4-korpus | Paypoq, qoʻlqop, bosh kiyim, sochiq, ichki kiyim, poyabzal, kundalik ehtiyoj mollari | Chorsu, Abu Sahiy ulgurji savdosi |
| 5-korpus | Import tovarlar, choyshab va uy tekstili, avto aksessuarlari, parda, trikotaj matolari | Uy-roʻzgʻor va avto doʻkonlari |

Korpuslardan tashqari Ivuda alohida ixtisoslashgan bozorlar bor: Huangyuan kiyim bozori (arzon segment kiyim), ishlab chiqarish materiallari bozori va shahar atrofidagi yuzlab kichik zavodlar. Ivudagi doʻkonlarning koʻpi — zavodning vitrinasi: doʻkonda namuna, ombor va sex shahar chetida.

Uchta qoida bozorda darrov koʻzga tashlanadi. Minimal partiya — odatda bitta quti (一箱起批): 12, 24, 48 yoki 100 dona. Narx dona boshiga yuanda aytiladi va partiya kattalashgani sari tushadi. Bitta tovarning 2–3 sifat darajasi boʻladi — sotuvchi soʻrasangiz koʻrsatadi, soʻramasangiz eng arzonini beradi.

## Guanchjou: kiyim, sumka, poyabzal va elektronika qayerda?

Guanchjou — Guandun provinsiyasining markazi, Xitoy janubidagi eng katta ulgurji shahar. Bu yerda bozorlar tovar guruhi boʻyicha butun koʻcha va mavzelarga boʻlingan:

- **Sumka va charm buyumlar** — Baiyun (白云) jahon charm buyumlari savdo markazi va Guihuagang bozorlari, Sanyuanli hududi. Sumka, hamyon, kamar, chamadon — arzon segmentdan brendsiz sifatli mahsulotgacha.
- **Kiyim** — Shahe (沙河) bozorlari: eng arzon ulgurji kiyim, savdo tong 5:00 dan boshlanib tushgacha faol. Shisanhang (十三行) — ayollar modasi, assortiment har hafta yangilanadi. Baima (白马) — temir yoʻl vokzali yonida, oʻrta va yuqori narx segmenti.
- **Poyabzal va soat** — Zhanxi yoʻli (站西路) atrofidagi savdo markazlari.
- **Oʻyinchoq, kanselyariya, bayram bezaklari** — Yide yoʻli (一德路) va Wanling Plaza.
- **Kosmetika va goʻzallik tovarlari** — Xingfa Plaza, Guangyuan yoʻli.
- **Mato va furnitura** — Zhongda (中大) mato bozori, Haizhu tumani: tikuvchilik sexlari uchun mato, ip, tugma, zamok.
- **Elektronika** — Tianhe tumanidagi Gangding kompyuter bozorlari va Dashatou (ikkilamchi elektronika). Katta hajmdagi elektronika uchun Shenchjen qulayroq.

Kanton yarmarkasi (广交会) Pazhou majmuasida yiliga ikki marta oʻtadi — aprel-may va oktabr-noyabr — va tovar guruhlari boʻyicha uch bosqichga boʻlinadi: birinchisi elektronika, uskuna, qurilish materiallari; ikkinchisi uy-roʻzgʻor va sovgʻa tovarlari; uchinchisi kiyim, poyabzal, sumka, oziq-ovqat.

## Shenchjen, Keqiao va Foshan: ixtisoslashgan bozorlar
...
| Mezon | Safar bilan xarid | Masofaviy xarid |
|---|---|---|
...
| Sana | Voqea | Bozor va yuk uchun nima degani |
|---|---|---|
| Yanvar oxiri – fevral (2027-yil 6-fevral) | Xitoy Yangi yili | Bozorlar 2–3 hafta, zavodlar 3–4 hafta yopiq. Ombor bayramdan taxminan bir hafta oldin qabulni toʻxtatadi, birinchi reys 2–3 hafta keyin. Uzum sotuvchisiga 2 oylik zaxira kerak |
| 15-aprel – 5-may | Kanton yarmarkasi (bahor), 3 bosqich | Guanchjouda mehmonxona qimmat, yangi mahsulotlar; 1–5 may mehnat bayrami dam olishi |
| 18-iyun | 618 savdo kuni | Ekspress kompaniyalar bandroq, sotuvchi 1–3 kun kech joʻnatadi |
| 1–7 oktabr | Oltin hafta (Milliy bayram) | Bozorlar 3–7 kun yopiq, chegarada navbat, yoʻlga taxminan 5–7 kun qoʻshiladi |
| 15-oktabr – 4-noyabr | Kanton yarmarkasi (kuz), 3 bosqich | Yangi kolleksiyalar, sotuvchilar yarmarkada — javob sekin |
| 21–25 oktabr | Ivu tovarlar yarmarkasi | Ivuda mehmonxona va taksi qimmat |
| 11-noyabr | 11.11 | Zavod va ekspress kompaniyalar toʻla yuklangan, sotuvchi 3–7 kun kech joʻnatadi; kargo aksiyalari; dekabrgacha reyslar toʻla |

Amaliy xulosa: yanvar va oktabr reyslariga buyurtmani bayramdan 3–4 hafta oldin bering; noyabr-dekabrda joy oldindan band qilinadi. Muddatlar taxminiy va yuk Xitoy omboridan joʻnatilgandan keyin hisoblanadi; yoʻnalish tafsilotlari — [Xitoydan Toshkentga yoʻnalishlar](/qollanma/xitoydan-toshkentga-yonalishlar/).

## Amaliy maslahatlar

1. Bozorga toza roʻyxat bilan boring: tovar, kerakli soni, maqsad narxi. Bozorda 10 ta yangi gʻoya paydo boʻladi — roʻyxat byudjetni saqlaydi.
2. Doʻkon raqamini fotoga oling: raqam korpus va qavatni bildiradi, takroriy buyurtma Yiwugo orqali shu raqam bilan beriladi.
