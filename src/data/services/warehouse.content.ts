...
const content: ServiceContentByLang = {
  uz: {
    ...
    sections: [
      {
        ...
        body: [
          'Xitoyda tovar sotib olganingizda u sizga toʻgʻridan-toʻgʻri kelmaydi — avval Xitoy ichidagi manzilga, yaʼni omborga boradi. Ivu ombori aynan shu manzil: 1688 yoki Taobao sotuvchisi, Futian bozoridagi doʻkon yoki Guanchjoudagi zavod yukni shu yerga joʻnatadi. Guanchjou, Shenchjen va boshqa shaharlardan hamkor omborlar orqali qabul qilamiz.',
        ...
        bullets: [
          'Uzum va Instagram sotuvchilari: bir necha sotuvchidan kelgan mayda buyurtmalarni bitta yuk kodiga jamlaymiz.',
      ...
      },
      {
        ...
        body: [
          'Shartnoma tuzilgach, sizga Ivu omborining xitoycha manzili va shaxsiy mijoz kodi beriladi. Yetkazib beruvchi har bir qutiga shu kodni yozadi — shunda ombor qutini kelgan zahoti sizniki deb taniydi. Qabul quyidagicha kechadi:',
        ],
        steps: [
          { title: 'Kod bilan belgilash', text: 'Har bir joy qabul qilinadi, mijoz kodi va joy raqami yopishtiriladi. Kodsiz kelgan quti yetkazib beruvchining trek raqami boʻyicha aniqlanadi — buning uchun buyurtma maʼlumotini oldindan yuborasiz.' },
      ...
      },
      {
        ...
        body: [
          'Foto-hisobot — sizning Ivudagi koʻzingiz. Oddiy qabulda tarozi koʻrsatkichi, quti va yorliq surati keladi. Tafsilotli hisobotda esa ochilgan quti, tovarning umumiy koʻrinishi, yaqindan olingan surat, mavjud brak va sanoq natijasi boʻladi. Har bir hisobot yuk kodi va sana bilan Telegramga yuboriladi, shuning uchun keyin har qanday joyni topish oson.',
    ...
    faq: [
      { q: 'Ivu ombori manzilini qanday olaman?', a: 'Shartnoma tuzilgach, menejer sizga xitoycha manzil, qabul qiluvchi telefoni va shaxsiy mijoz kodingizni Telegramda yuboradi. Manzilni 1688/Taobao buyurtmasiga yoki sotuvchiga toʻgʻridan-toʻgʻri berasiz.' },
    ...
    cta: {
      title: 'Yukingiz Ivuda — koʻz oʻngingizda.',
      text: 'Nechta sotuvchidan qancha yuk kutayotganingizni yozing — ombor manzili va kodingizni beramiz, tekshiruv va qadoqlash variantini maslahat beramiz.',
      draft: 'Assalomu alaykum! Ivu ombori xizmatlari kerak. Sotuvchilar soni: … Tovar: … Taxminiy ogʻirlik: … kg. Ochib tekshirish: kerak / kerak emas.',
    },
    updated: '2026-09-08',
  },
  ...
  ru: {
    ...
    sections: [
      {
        ...
        body: [
          'Купленный в Китае товар не приходит к вам напрямую — сначала он едет на адрес внутри Китая, то есть на склад. Склад в Иу и есть этот адрес: продавец с 1688 или Taobao, лавка на рынке Футянь или фабрика в Гуанчжоу отправляют груз сюда. Из Гуанчжоу, Шэньчжэня и других городов принимаем через партнёрские склады.',
        ...
        bullets: [
          'Продавцы Uzum и Instagram: собираем мелкие заказы от нескольких продавцов под одним кодом груза.',
      ...
      },
      {
        ...
        body: [
          'После заключения договора вы получаете китайский адрес склада в Иу и личный код клиента. Поставщик пишет этот код на каждой коробке — так склад узнаёт вашу коробку сразу при поступлении. Приёмка идёт так:',
        ],
        steps: [
          { title: 'Маркировка кодом', text: 'Каждое место принимается, на него клеится код клиента и номер места. Коробку без кода находим по трек-номеру поставщика — для этого вы заранее присылаете данные заказа.' },
          ...
          { title: 'Консолидация', text: 'Готовые места собираются в одну партию под вашим кодом груза и грузятся в ближайшую фуру или контейнер. Вам приходят номер партии и дата отправки.' },
        ],
      },
      {
        heading: 'Что входит в фотоотчёт?',
        body: [
          'Фотоотчёт — ваши глаза в Иу. При обычной приёмке приходят показания весов, фото коробки и этикетки. В подробном отчёте — вскрытая коробка, общий вид товара, крупный план, найденный брак и результат пересчёта. Каждый отчёт отправляется в Telegram с кодом груза и датой, поэтому любое место потом легко найти.',
    ...
    faq: [
      { q: 'Как получить адрес склада в Иу?', a: 'После заключения договора менеджер присылает в Telegram китайский адрес, телефон получателя и ваш личный код клиента. Адрес вы указываете в заказе на 1688/Taobao или передаёте продавцу напрямую.' },
    ...
    guideKeys: ['yiwu-guangzhou', 'shipping-from-china', 'prohibited-goods', 'order-from-1688'],
    cta: {
      title: 'Ваш груз в Иу — как на ладони.',
      text: 'Напишите, сколько груза и от скольких продавцов вы ждёте — дадим адрес склада и ваш код, посоветуем вариант проверки и упаковки.',
      draft: 'Здравствуйте! Нужны услуги склада в Иу. Число продавцов: … Товар: … Примерный вес: … кг. Проверка со вскрытием: нужна / не нужна.',
    },
    updated: '2026-09-08',
  },
  ...
  en: {
    key: 'warehouse',
    seo: {
      title: 'Yiwu warehouse: receiving, quality control, photo reports, packing — GSR Logistics',
      description:
        'At the Yiwu warehouse in China we receive your cargo, label it with your client code, open and inspect it, send photo reports, consolidate goods from several suppliers, repack and insure for 1%. 14 days of free storage.',
    },
    hero: {
      eyebrow: 'Service 08 — Yiwu warehouse',
      h1: 'Yiwu warehouse: receiving, quality control and photo reports',
      intro:
        'The Yiwu (义乌) warehouse is the first stop for every shipment from China to Tashkent. Here each piece from your supplier is weighed, measured, labelled with your client code and photographed. On request we open the boxes, count and inspect the goods ($1/kg), repack them ($0.40/kg) and insure the cargo for 1% of its declared value. Storage is free for up to 14 days.',
      facts: [
        { label: 'Free storage, Yiwu', value: '14 days' },
    ...
    sections: [
      {
        ...
        body: [
          'Goods bought in China do not come to you directly — they first go to an address inside China, which is the warehouse. The Yiwu warehouse is that address: a seller on 1688 or Taobao, a stall at the Futian market or a factory in Guangzhou ships the cargo here. From Guangzhou, Shenzhen and other cities we receive goods through partner warehouses.',
        ...
        bullets: [
          'Uzum and Instagram sellers: we gather small orders from several sellers under one cargo code.',
      ...
      },
      {
        ...
        body: [
          'Once the contract is signed you receive the Chinese address of the Yiwu warehouse and a personal client code. The supplier writes this code on every box, so the warehouse recognises your box the moment it arrives. Receiving works like this:',
        ],
        steps: [
          { title: 'Labelling with your code', text: 'Every piece is accepted and labelled with your client code and a piece number. A box that arrives without a code is identified by the supplier’s tracking number — which is why you send the order details in advance.' },
    ...
    faq: [
      { q: 'How do I get the Yiwu warehouse address?', a: 'Once the contract is signed, your manager sends the Chinese address, the receiver’s phone number and your personal client code on Telegram. You enter the address in your 1688/Taobao order or give it to the seller directly.' },
      { q: 'How will I know my cargo has reached the warehouse?', a: 'At every receipt a photo of the scale and the label with your cargo code arrives on Telegram — usually on the day the box comes in. If you send the tracking number of an expected box in advance, the warehouse identifies it immediately.' },
      ...
      { q: 'Can cargo from several sellers be combined into one shipment?', a: 'Yes — that is consolidation, one of the warehouse’s main jobs. All boxes wait under your code free for up to 14 days, then they are gathered into one lot and shipped. If you wish, we repack the boxes to reduce the volume ($0.40/kg).' },
      ...
      { q: 'How long is storage free?', a: '14 days in Yiwu and 3 days in Tashkent. After that a daily charge applies under the contract. Before Chinese New Year the warehouse stops receiving a week ahead of the holiday — plan your lot accordingly.' },
    ...
    guideKeys: ['yiwu-guangzhou', 'shipping-from-china', 'prohibited-goods', 'order-from-1688'],
    cta: {
      title: 'Your cargo in Yiwu, in plain sight.',
      text: 'Tell us how much cargo you expect and from how many sellers — we will send the warehouse address and your code and suggest the inspection and packing options.',
      draft: 'Hello! I need the Yiwu warehouse services. Number of sellers: … Product: … Approximate weight: … kg. Inspection with opening: yes / no.',
    },
    updated: '2026-09-08',
  },
};
