...
const content: ServiceContentByLang = {
  ...
  ru: {
    ...
    hero: {
      ...
      intro:
        'Пункт приёма в Китае — Иу (义乌), Гуанчжоу (广州) или Кашгар (喀什) — первая остановка груза на пути в Ташкент. Здесь каждое место от поставщика взвешивают, обмеряют, маркируют вашим GS-кодом и фотографируют. По желанию вскрываем коробки, пересчитываем и проверяем товар (1 $/кг), переупаковываем (0,4 $/кг) и страхуем груз за 1% от объявленной стоимости. Хранение до 14 дней бесплатно.',
      facts: [
