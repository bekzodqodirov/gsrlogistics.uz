  ...
  uz: {
    ...
    sections: [
      {
        ...
        body: [
          'Yigʻma yuk (LCL, «sborniy») — Xitoydan tovar olib kelishning eng koʻp tarqalgan usuli. Yukingiz Ivu (义乌) omborimizda boshqa mijozlarning yuklari bilan bitta fura yoki konteynerga joylanadi, shuning uchun 1 kg yuk uchun ham, 10 m³ yuk uchun ham faqat oʻz ulushingizga toʻlaysiz. Guanchjou, Shenchjen va boshqa shaharlardan ham qabul qilamiz: yetkazib beruvchi yukni Ivu omborimizga joʻnatadi yoki hamkorlarimiz olib keladi.',
      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'Ombor manzilini olasiz', text: 'Sizga Ivu omborimizning manzili va shaxsiy kodingiz beriladi. Yetkazib beruvchi yoki 1688/Taobao sotuvchisi yukni shu manzilga joʻnatadi.' },
          ...
          { title: 'Toshkentda qabul qilasiz', text: 'Yuk Toshkent omborimizga keladi. Toʻlovni yakunlaysiz va yukni olib ketasiz yoki eshikkacha yetkazib beramiz; viloyatlarga yetkazishni alohida kelishamiz.' },
        ],
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Qabul qilamiz: yetkazib beruvchi yukni Ivu omborimizga Xitoy ichki pochtasi bilan joʻnatadi (odatda 1–3 kun), yoki hamkor omborimiz orqali olamiz. Xitoy ichidagi yetkazib berish narxi sotuvchi bilan kelishiladi.',
      },
      {
  ...
  ru: {
    ...
    sections: [
      {
        ...
        body: [
          'Сборный груз (LCL) — самый распространённый способ привезти товар из Китая. Ваш груз на нашем складе в Иу (义乌) укладывается в одну фуру или контейнер вместе с грузами других клиентов, поэтому и за 1 кг, и за 10 м³ вы платите только за свою долю. Принимаем также из Гуанчжоу, Шэньчжэня и других городов: поставщик отправляет товар на наш склад в Иу или его забирают наши партнёры.',
      ...
      },
      {
        ...
        table: {
          ...
          head: ['Этап', 'Что происходит', 'Ориентировочно'],
          rows: [
      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'Получаете адрес склада', text: 'Вы получаете адрес нашего склада в Иу и личный код. Поставщик или продавец на 1688/Taobao отправляет товар на этот адрес.' },
          ...
          { title: 'Получаете в Ташкенте', text: 'Груз приходит на наш склад в Ташкенте. Вы закрываете оплату и забираете груз, либо мы доставляем до двери; доставку в регионы согласуем отдельно.' },
        ],
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Принимаем: поставщик отправляет груз на наш склад в Иу внутрикитайской доставкой (обычно 1–3 дня) либо мы забираем его через партнёрский склад. Стоимость доставки внутри Китая согласуется с продавцом.',
      },
      {
  ...
  en: {
    ...
    sections: [
      {
        ...
        body: [
          'Consolidated cargo (LCL, groupage) is the most common way to bring goods from China. Your shipment is loaded at our Yiwu (义乌) warehouse into one truck or container together with other clients’ goods, so whether you send 1 kg or 10 m³ you pay only for your share. We also receive from Guangzhou, Shenzhen and other cities: the supplier ships to our Yiwu warehouse, or our partners collect it.',
      ...
      },
      {
        ...
        body: [
          'First we determine the density of your cargo: total weight (kg) divided by total volume (m³). At 170 kg/m³ or more you pay per kilogram; below that, per cubic metre. Either way the quoted price covers the whole journey from the Yiwu warehouse to our Tashkent warehouse.',
      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'You get a warehouse address', text: 'We give you the address of our Yiwu warehouse and your personal code. Your supplier or 1688/Taobao seller ships to that address.' },
          ...
          { title: 'You collect in Tashkent', text: 'The cargo arrives at our Tashkent warehouse. You settle the invoice and pick it up, or we deliver to your door; delivery to the regions is arranged separately.' },
        ],
      },
      {
        heading: 'What is included, and what costs extra?',
        body: [
          'The per-kilogram or per-cubic-metre price is the full service from the Yiwu warehouse to our Tashkent warehouse. It includes:',
        ],
        bullets: [
          ...
          'Delivery to our Tashkent warehouse and free storage for up to 3 days',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'We accept them: the supplier ships to our Yiwu warehouse by domestic delivery (usually 1–3 days), or we collect through a partner warehouse. The cost of delivery inside China is agreed with the seller.',
      },
      {
      ...
      },
      {
        ...
        a: 'You settle when the cargo has arrived at our Tashkent warehouse, before pick-up; the price is agreed in US dollars and paid in soums — cash, card, or by invoice for companies. The exact terms are set out in the contract.',
      },
    ],
    related: ['warehouse', 'customs', 'air'],
    guideKeys: ['shipping-from-china', 'cargo-pricing', 'routes', 'prohibited-goods'],
