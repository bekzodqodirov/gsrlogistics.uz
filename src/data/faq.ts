  ...
  return [
    {
      ...
      items: [
        ...
        { q: 'Viloyatlarga yetkazib berasizmi va bu qancha turadi?',
          a: `Ha, Oʻzbekistonning barcha viloyatlariga yetkazamiz. Viloyat filialigacha yetkazish bepul, uygacha yetkazish taxminan ${v.door}. Toshkent shahrida ${v.doorFreeKg} kg dan ogʻir yukni uygacha bepul olib boramiz. Yuk Toshkent omboriga tushgach, menejer joʻnatish sanasini xabar qiladi.` },
      ],
    },
    {
      ...
      items: [
        ...
        { q: 'Yuk qaysi yoʻnalish orqali keladi?',
          a: `Asosiy yoʻnalish: Ivu → Urumchi → Xorgos (Xitoy–Qozogʻiston chegarasi) → Olmaota → Shimkent → Toshkent, taxminan 5 000+ km. Fargʻona vodiysi uchun Qashqar → Irkeshtam → Oʻsh → Andijon yoʻli ham bor — Xitoyning gʻarbidan bu yoʻl yuzlab kilometr qisqa. Avia yuk Guanchjou yoki Urumchidan uchadi, temir yoʻl konteynerlari Doʻstiq va Oltinkoʻl orqali oʻtadi. Xitoy–Qirgʻiziston–Oʻzbekiston temir yoʻli hali qurilmoqda — u bizning yoʻnalishimizga kirmaydi.` },
        ...
        { q: 'Yuk qayerdaligini qanday bilaman?',
          a: `Har qabulda foto-hisobot, joʻnatishda partiya raqami va yuk kodi beriladi. Kuzatuv sahifasida yuk kodini kiritasiz — menejer Telegramda joriy holat (Ivu omborida · Yoʻlda · Xorgosda · Toshkent omborida · Yetkazildi) va foto bilan javob beradi. Xitoy ichidagi kuryer trek-kodi (1688, Taobao) bundan alohida — uni ombor qabulida tekshiramiz.` },
      ],
    },
    {
      ...
      items: [
        { q: 'Ishni qanday boshlayman va yukni Xitoyda qayerga yuboraman?',
          a: `Telegramda yozasiz yoki qoʻngʻiroq qilasiz; transport turi, hujjatlar va qadoqlashni kelishib, shartnoma tuzamiz. Keyin menejer Ivu (义乌) omborining manzilini va mijoz kodingizni beradi — yetkazib beruvchi tovarni shu manzilga, shu kod bilan joʻnatadi. Guanchjou, Shenchjen va boshqa shaharlardan hamkorlar orqali qabul qilamiz. Ombor (sklad, склад) manzili shartnomadan keyin beriladi — tovar adashib ketmasligi uchun.` },
        { q: 'Bir nechta yetkazib beruvchidan kelgan tovarni birlashtira olasizmi?',
          a: `Ha, konsolidatsiya — asosiy ishimiz. Turli zavod va doʻkonlardan kelgan joylarni Ivu omborida bitta mijoz kodi ostida yigʻamiz, qayta oʻlchaymiz va bitta partiyada joʻnatamiz. Bu har joyni alohida joʻnatishdan arzon: umumiy ogʻirlik ${v.denseMin} kg dan oshsa, pastroq tarif qoʻllanadi. Kutilayotgan joylar haqida menejerga oldindan xabar bering.` },
        ...
        { q: 'Yukni Toshkent omboridan oʻzim olib keta olamanmi?',
          a: `Ha, toʻlovdan keyin yuk kodi bilan Toshkent omboridan oʻzingiz olib ketishingiz mumkin; ombor manzili va ish vaqtini menejer yuboradi. Istasangiz, shahar boʻylab (${v.doorFreeKg} kg dan bepul) yoki viloyatga yetkazamiz. Yuk omborda ${v.storeTz} kun bepul saqlanadi.` },
      ],
    },
    {
      ...
      items: [
        ...
        { q: 'Sertifikat va oʻzbekcha yorliq shartmi?',
          a: `Tovar kodiga bogʻliq: 2025-yil sentabrdagi PKM-554 majburiy sertifikatlash roʻyxatini qisqartirdi, lekin elektr jihozlar, bolalar tovarlari, oʻyinchoq, kosmetika va oziq-ovqat uchun muvofiqlik hujjati va SES xulosasi saqlanib qolgan. Sertifikat yoki SES talab qilinadigan isteʼmol tovarlarida 2024-yil 1-yanvardan (UP-140) lotin yozuvidagi oʻzbekcha yorliq boʻlishi shart. Yorliqni zavodning oʻzida yopishtirishni yetkazib beruvchi bilan kelishib beramiz.` },
        { q: 'Bojxona rasmiylashtiruvi qancha turadi va qancha vaqt oladi?',
          a: `Davlat yigʻimi tovar qiymatiga bogʻliq: 10 000 $ gacha 1 BRV, 20 000 $ gacha 1,5 BRV va yuqoriga qarab oshadi (PKM-55, 2025). Hujjatlar toʻliq boʻlsa, chiqarish odatda 1 ish kuni; tekshiruv yoki sertifikat kutilsa, koʻproq. Bizning rasmiylashtiruv xizmatimiz narxi yuk turiga qarab shartnomada yoziladi — oldindan hisob beramiz va keyin oʻzgartirmaymiz.` },
      ],
    },
    {
      ...
      items: [
        ...
        { q: '1688, Taobao yoki Alibabaʼdan qanday buyurtma beraman va toʻlayman?',
  ...
  return [
    {
      ...
      items: [
        ...
        { q: 'Доставляете ли в регионы и сколько это стоит?',
          a: `Да, доставляем во все области Узбекистана. До филиала в регионе — бесплатно, до двери — ориентировочно ${v.door}. По Ташкенту груз тяжелее ${v.doorFreeKg} кг привозим до двери бесплатно. Как только груз выгружен на ташкентском складе, менеджер сообщает дату отправки в регион.` },
      ],
    },
    {
      ...
      items: [
        ...
        { q: 'По какому маршруту едет груз?',
          a: `Основной маршрут: Иу → Урумчи → Хоргос (граница Китая и Казахстана) → Алматы → Шымкент → Ташкент, ориентировочно 5 000+ км. Для Ферганской долины есть путь Кашгар → Иркештам → Ош → Андижан — из западного Китая он на сотни километров короче. Авиагруз летит из Гуанчжоу или Урумчи, ж/д контейнеры идут через Достык и Алтынколь. Железная дорога Китай — Киргизия — Узбекистан ещё строится и в наши маршруты не входит.` },
        ...
        { q: 'Как узнать, где сейчас мой груз?',
          a: `При каждой приёмке вы получаете фотоотчёт, при отправке — номер партии и код груза. На странице отслеживания вводите код груза — менеджер отвечает в Telegram текущим статусом (На складе в Иу · В пути · На Хоргосе · На складе в Ташкенте · Доставлено) и фото. Трек-номер китайского курьера (1688, Taobao) — это отдельная вещь, его мы сверяем при приёмке на складе.` },
      ],
    },
    {
      ...
      items: [
        { q: 'С чего начать и куда отправлять груз в Китае?',
          a: `Пишете в Telegram или звоните; согласуем вид транспорта, документы и упаковку, заключаем договор. Затем менеджер даёт адрес склада в Иу (义乌) и ваш код клиента — поставщик отправляет товар на этот адрес с этим кодом. Из Гуанчжоу, Шэньчжэня и других городов принимаем через партнёров. Адрес склада выдаём после договора — чтобы груз не потерялся.` },
        { q: 'Можно ли объединить товар от нескольких поставщиков?',
          a: `Да, консолидация — наша основная работа. Места от разных фабрик и магазинов собираем на складе в Иу под одним кодом клиента, перемеряем и отправляем одной партией. Это дешевле, чем везти каждое место отдельно: если общий вес превышает ${v.denseMin} кг, действует более низкая ставка. Предупредите менеджера заранее, какие места ожидаются.` },
        ...
        { q: 'Могу ли я забрать груз со склада в Ташкенте сам?',
          a: `Да, после оплаты вы забираете груз по коду со склада в Ташкенте; адрес и часы работы склада присылает менеджер. По желанию доставим по городу (от ${v.doorFreeKg} кг бесплатно) или в регион. На складе груз хранится бесплатно ${v.storeTz} дня.` },
      ],
    },
    {
  ...
  return [
    {
      ...
      items: [
        ...
        { q: 'Do you deliver to the regions, and what does it cost?',
          a: `Yes, we deliver to every region of Uzbekistan. Delivery to a regional branch is free; to the door it is roughly ${v.door}. In Tashkent, cargo heavier than ${v.doorFreeKg} kg is delivered to the door free of charge. Once the cargo is unloaded at the Tashkent warehouse, your manager confirms the dispatch date.` },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        { q: 'How do I start, and where do I send goods in China?',
          a: `Message us on Telegram or call; we agree the transport mode, documents and packing and sign a contract. Your manager then gives you the Yiwu (义乌) warehouse address and your client code — the supplier ships to that address with that code. From Guangzhou, Shenzhen and other cities we receive through partners. The warehouse address is issued after the contract so that goods never go astray.` },
        { q: 'Can you combine goods from several suppliers?',
          a: `Yes — consolidation is our core service. Pieces from different factories and shops are gathered at the Yiwu warehouse under one client code, re-measured and shipped as one batch. It is cheaper than shipping each piece alone: once the total passes ${v.denseMin} kg, a lower rate applies. Tell your manager in advance which pieces to expect.` },
        ...
        { q: 'Can I collect the cargo from the Tashkent warehouse myself?',
          a: `Yes, after payment you can collect with your cargo code; your manager sends the warehouse address and opening hours. If you prefer, we deliver within the city (free from ${v.doorFreeKg} kg) or to your region. Storage at the warehouse is free for ${v.storeTz} days.` },
      ],
    },
    {
      ...
      items: [
        ...
        { q: 'What is the $200 limit for individuals?',
          a: `Since 1 May 2025 (Cabinet Resolution PKM-244) an individual can receive up to $200 of goods per month through courier shipments before customs charges anything; the limit is cumulative across all of one person’s orders in the month. Above it, a single customs payment of 30% (min. $3/kg) applies; from 1 January 2027 the rate is planned to fall to 20% and $2/kg (Decree PF-174). If many identical items are ordered, customs may treat the shipment as commercial. Stock for a shop is commercial cargo and goes through full clearance.` },
        ...
        { q: 'Are a certificate and Uzbek labelling required?',
          a: `It depends on the HS code: Resolution PKM-554 of September 2025 shortened the mandatory certification list, but electrical goods, children’s products, toys, cosmetics and food still need a conformity document and an SES conclusion. Consumer goods that need a certificate or SES must carry Uzbek-language labelling in Latin script since 1 January 2024 (Decree UP-140). We arrange labelling at the factory with the supplier.` },
