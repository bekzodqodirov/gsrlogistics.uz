    ...
    },
    {
      ...
      items: [
        { q: 'How do I start, and where do I send goods in China?',
          a: `Message us on Telegram or call; we agree the transport mode, documents and packing and sign a contract. There are three receiving addresses in China — Yiwu (义乌), Guangzhou and Kashgar — and your manager tells you which one applies. The manager also gives you your GS code (shipping mark): the supplier writes the GS code on every carton before dispatch and ships to that address. The receiving address is issued after the contract so that goods never go astray.` },
