    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Yuk qaysi yoʻnalish orqali keladi?',
          a: `Asosiy yoʻnalish: Ivu → Urumchi → Xorgos (Xitoy–Qozogʻiston chegarasi) → Olmaota → Shimkent → Toshkent, taxminan 5 000+ km. Fargʻona vodiysi uchun Qashqar → Irkeshtam → Oʻsh → Andijon yoʻli ham bor — Xitoyning gʻarbidan bu yoʻl yuzlab kilometr qisqa. Avia yuk Guanchjou yoki Urumchidan uchadi, temir yoʻl konteynerlari Dostiq va Altinkoʻl orqali oʻtadi. Xitoy–Qirgʻiziston–Oʻzbekiston temir yoʻli hali qurilmoqda — u bizning yoʻnalishimizga kirmaydi.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'По какому маршруту едет груз?',
          a: `Основной маршрут: Иу → Урумчи → Хоргос (граница Китая и Казахстана) → Алматы → Шымкент → Ташкент, ориентировочно 5 000+ км. Для Ферганской долины есть путь Кашгар → Иркештам → Ош → Андижан — из западного Китая он на сотни километров короче. Авиагруз летит из Гуанчжоу или Урумчи, ж/д контейнеры идут через Достык и Алтынколь. Железная дорога Китай — Кыргызстан — Узбекистан ещё строится и в наши маршруты не входит.` },
